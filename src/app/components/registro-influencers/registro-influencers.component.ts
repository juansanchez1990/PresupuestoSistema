...
@Component({
  selector: 'app-registro-influencers',
  templateUrl: './registro-influencers.component.html',
  styleUrls: ['./registro-influencers.component.css']
})



export class RegistroInfluencersComponent implements OnInit {
 ...
 this.RegistroI.EditInfluencer(this.idInfluencer, EditInfluencer).subscribe(data=>{
  ...
  getRegistros() {
    this.RegistroI.getDetallesPago(11).subscribe(data => {
